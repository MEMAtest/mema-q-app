        ...
        for (const item of section.items) {
            await prisma.question.create({
                data: {
                    ...
                    complianceImplicationIfNo: item.complianceImplicationIfNo || null,
                    complianceImplicationIfSelected: item.complianceImplicationIfSelected ? JSON.stringify(item.complianceImplicationIfSelected) : null,
                },
            });
            console.log(`Created question with id: ${item.id}`);
        }
    }
